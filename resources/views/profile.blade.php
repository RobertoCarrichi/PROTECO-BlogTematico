            ...
            <div class="collapse navbar-collapse d-flex justify-content-end" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item mx-0 mx-lg-1">
                        <a class="nav-link active py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="{{route('index.varonil')}}">Varonil</a>
                    </li>
                    <li class="nav-item mx-0 mx-lg-1">
                        <a class="nav-link active py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="{{route('index.femenil')}}">Femenil</a>
                    </li>
                    @guest
                    <li class="nav-item mx-0 mx-lg-1">
        ...
        <section class="page-section" id="avatar-nombre">
             <div id="perfil" class="masthead bg-secondary text-white text-center">
                <div class="container d-flex align-items-center flex-column justify-content-center">
                    ...
                    <img id="img-perfil" class="d-flex rounded-circle mt-4 mb-4" src="{{asset("avatars/$user->avatar")}}" alt="Avatar de {{$user->name}}">
                    <!-- Masthead Heading-->
